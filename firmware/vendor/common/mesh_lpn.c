...
//extern  u8 gw_tx_buff[];
//u8 i2c_tx_buff[TX_BUFF_DATA_LEN] = {OPT3001_CONFIG_REG_HIGH,OPT3001_CONFIG_REG_LOW};
//u8 i2c_rx_buff[RX_BUFF_DATA_LEN] = {0};
//
//
//#define LIGHT_SENSOR_MODULE_TYPE               0x0001
//#define LIGHT_SENSOR_IN_PIR_MODULE_TYPE        0x0002
//#define PIR_SENSOR_IN_PIR_MODULE_TYPE          0x0003
//
//#define RD_LIGHT_SENSOR_OPCODE                 0x01
///////////////////////////////////////////////////////////////////////////////////////////////

//extern u16  FRI_POLL_INTERVAL_MS   ;
...
//u8 check_done;
//bool init_led=0;
extern u16 RD_LS_TransferCntInMin;
extern u32 RD_LS_TransferCntInHour;
// friend_poll = 2000;
void mesh_friend_ship_start_poll()
{
	RD_light_sensor_tx(RD_LS_TransferCntInHour/friend_poll);
...
//		RD_Factory_Reset_Flash_Write_Buff[0]=reset_cnt;
	...
	if(lpn_provision_ok){
	    ...
	    if(!is_provision_success()){
	        if(!is_provision_working()){   // not being provision
    	        if(clock_time_exceed(0, provision_time*1000)){
    	            light_onoff_all(0);
