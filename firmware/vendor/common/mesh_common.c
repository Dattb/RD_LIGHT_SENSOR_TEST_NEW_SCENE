...
//	}
//RD_EDIT  RD Type device
#define RD_SENOR_TYPE_DEVICE 03
#define RD_LIGHT_SENSOR_TYPE_DEVICE 01
#define RD_NONE   0
#define RD_LIGHT_SENSOR_CB03_LS_BLE_TYPE_DEVICE 01
#define TYPE_DEVICE_SIZE  11
	for(char i=0;i<TYPE_DEVICE_SIZE;i++) tbl_scanRsp.rsv_user[i] = 0;
	tbl_scanRsp.rsv_user[0] = RD_SENOR_TYPE_DEVICE;
	tbl_scanRsp.rsv_user[1] = RD_LIGHT_SENSOR_TYPE_DEVICE;
	tbl_scanRsp.rsv_user[2] = RD_LIGHT_SENSOR_CB03_LS_BLE_TYPE_DEVICE;
