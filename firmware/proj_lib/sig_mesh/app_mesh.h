...
//RD_EDIT: so ban tin chuyen toi da trong 1 lan thuc day
#define TRANSMIT_CNT_LPN_ACCESS_CMD  	(64)
...
//RD_EDIT: so ban tin chuyen toi da trong 1 lan thuc day
#define MESH_ADV_CMD_BUF_CNT    (64)
#if WIN32 
...
// RD_EDIT: poll timeout
#define LPN_POLL_TIMEOUT_100MS      (80*10) // unit: 100ms, 0x0A~0x34BBFF
#define FRI_POLL_INTERVAL_MS        (friend_poll)	// auto send poll interval
/*
 * RD_EDIT: friend poll
 */
#define FRI_REQ_TIMEOUT_MS          (6500)  // must larger than 1100ms
...
#define LPN_ADV_EN                  0
#define LPN_ADV_INTERVAL_MS         (5000)
